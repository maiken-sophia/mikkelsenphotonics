...
question: Can an electromagnetic environment change what a material is?
order: 4
...
summary: Materials are usually chosen for their intrinsic properties. We explore the reverse: an electromagnetic environment that activates behavior the material cannot show on its own.
